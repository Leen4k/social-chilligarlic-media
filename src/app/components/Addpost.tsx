  ...
  return (
    <>
      <div className="p-2 hidden lg:flex lg:pr-16 flex-1">
        <button
          onClick={openModal}
          className="text-xl flex items-end gap-4 bg-primary text-white rounded-full font-semibold py-3 w-full justify-center"
        >
          <span>Post</span>
        </button>
      </div>
      <div className="p-4 block lg:hidden">
        <button
          onClick={openModal}
          className="text-xl flex items-end gap-4 bg-primary text-white rounded-full p-4 font-semibold"
        >
          <span>
            <FaFeatherPointed />
          </span>
                ...
                <Dialog.Panel className="w-full relative max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="grid grid-cols-12 grid-rows-6 gap-2">
                    {downloadUrls.map((url, index) => (
                      <Image
                        key={index}
                        className={`${setImageSize(index)} w-full`}
                        src={url}
                        width={60}
                        height={60}
                        alt="post-img"
                  ...
                  >
                    ...
                    <button
                      ...
                      disabled:opacity-50 flex basis-1/4 items-end gap-4 bg-primary text-white rounded-full font-semibold py-2 w-full justify-center"
                    >
                      <span>Post</span>
                    </button>
                  </form>
